...
public class CreationalPatternsView extends FrameView {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = CreationalPatternsApp.getApplication().getMainFrame();
            aboutBox = new CreationalPatternsAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        CreationalPatternsApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(creationalpatterns.CreationalPatternsApp.class).getContext().getResourceMap(CreationalPatternsView.class);
        fileMenu.setText(resourceMap.getString("fileMenu.text")); // NOI18N
        fileMenu.setName("fileMenu"); // NOI18N

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(creationalpatterns.CreationalPatternsApp.class).getContext().getActionMap(CreationalPatternsView.class, this);
